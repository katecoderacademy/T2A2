class Address < ApplicationRecord
    ...
    validates :address_line_1, format: { with: /\A[a-zA-Z0-9 ,.;'"+-?!%$]*(?:\R[a-zA-Z0-9 ,.;'"+-?!%$]*)*\z/, message: 'First line of address cannot be blank and cannot be more than 50 characters.' }, length: { maximum: 50, message: 'First line of address cannot be blank and cannot be more than 50 characters' }
    ...
    validates :address_line_2, format: { with: /\A[a-zA-Z0-9 ,.;'"+-?!%$]*(?:\R[a-zA-Z0-9 ,.;'"+-?!%$]*)*\z/, message: 'First line of address cannot be blank and cannot be more than 50 characters.' }, length: { maximum: 50, message: 'First line of address cannot be blank and cannot be more than 50 characters' }, allow_blank:true
    ...
    validates :suburb, format: { with: /\A[a-zA-Z0-9 ,.;'"+-?!%$]*(?:\R[a-zA-Z0-9 ,.;'"+-?!%$]*)*\z/, message: 'Suburb/Town cannot be blank and cannot be more than 50 characters.'}, length: { maximum: 50, message: 'Suburb/Town cannot be blank and cannot be more than 50 characters.' }   
