class Course < ApplicationRecord
  ...
  validates :title,
            format: { with: /\A[a-zA-Z0-9 ,.;'"+-?!%$]*(?:\R[a-zA-Z0-9 ,.;'"+-?!%$]*)*\z/, message: 'Title cannot be blank and cannot be more than 100 characters.' }, length: { minimum: 2, maximum: 100, message: 'Title cannot be blank and cannot be more than 100 characters' }
  ...
  validates :description,
            format: { with: /\A[a-zA-Z0-9 ,.;'"+-?!%$]*(?:\R[a-zA-Z0-9 ,.;'"+-?!%$]*)*\z/, message: 'Description cannot be blank and must be between 30 and 4000 characters.' }, length: { minimum: 30, maximum: 4000, message: 'Description cannot be blank and must be between 30 and 4000 characters.' }
  ...
  validates :instructor_role,
            format: { with: /\A[a-zA-Z0-9 ,.;'"+-?!%$]*(?:\R[a-zA-Z0-9 ,.;'"+-?!%$]*)*\z/, message: 'Instructor Role cannot be blank and must be less than 100 characters.' }, length: { minimum: 2, maximum: 100, message: 'Instructor Role cannot be blank and must be less than 100 characters.' }
  ...
  validates :instructor_name,
            format: { with: /\A[a-zA-Z0-9 ,.;'"+-?!%$]*(?:\R[a-zA-Z0-9 ,.;'"+-?!%$]*)*\z/, message: 'Instructor name cannot be blank and must be less than 100 characters.' }, length: { minimum: 2, maximum: 40, message: 'Instructor name cannot be blank and must be less than 100 characters.' }
  ...
  validates :url, allow_blank: true, url: true,
                  length: { maximum: 150, message: 'Title cannot be blank and cannot be more than 100 characters' }
